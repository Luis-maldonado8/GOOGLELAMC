...
">
    ...
    <a href="/googlelamc/public/estadocivil/create">
        <button style="
                ...
                <?php foreach ($estadosciviles as $estadocivil): ?>
                    <tr style="background:#f9f9f9; border-bottom:1px solid #ddd;">
                        ...
                        <td style="padding:12px; text-align:center;">
                            ...
                            <a href="/googlelamc/public/estadocivil/edit?idestadocivil=<?php echo htmlspecialchars($estadocivil['idestadocivil']); ?>">
                                <button style="
                                    background:#facc15;
                                    color:#000;
                                    padding:7px 12px;
                            ...
                            <a href="/googlelamc/public/estadocivil/eliminar?idestadocivil=<?php echo htmlspecialchars($estadocivil['idestadocivil']); ?>"
