...
">
    ...
    <a href="/googlelamc/public/persona/create" style="text-decoration:none;">
        <button style="
            background:#1e5bff; 
            color:white; 
            padding:10px 20px; 
                ...
                <?php foreach ($personas as $persona): ?>
                    <tr style="background:white; border-bottom:1px solid #e2e2e2;">
                        ...
                        <td style="padding:12px;">
                            ...
                            <a href="/googlelamc/public/persona/view?idpersona=<?= htmlspecialchars($persona['idpersona']); ?>">
                                <button style="
                                    background:#17a2b8;
                                    color:white;
                                    padding:6px 12px;
                            ...
                            <a href="/googlelamc/public/persona/edit?idpersona=<?= htmlspecialchars($persona['idpersona']); ?>">
                                <button style="
                                    background:#ffc107;
                                    color:black;
                                    padding:6px 12px;
                            ...
                            <a href="/googlelamc/public/persona/deleteForm?id=<?= htmlspecialchars($persona['idpersona']); ?>"
