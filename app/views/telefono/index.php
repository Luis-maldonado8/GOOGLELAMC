...
<div class="container">
    ...
    <a href="/googlelamc/public/telefono/create" class="btn-agregar">
        ✚ Agregar Teléfono
    </a>
            ...
            <?php if (!empty($telefonos) && is_array($telefonos)): ?>
                <?php foreach ($telefonos as $telefono): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/googlelamc/public/telefono/edit?idtelefono=<?php echo htmlspecialchars($telefono['idtelefono']); ?>">
                                <button class="btn-editar">Editar</button>
                            </a>

                            <a href="/googlelamc/public/telefono/eliminar?idtelefono=<?php echo htmlspecialchars($telefono['idtelefono']); ?>"
