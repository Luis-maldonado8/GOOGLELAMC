...
">
    ...
    <a href="/googlelamc/public/direccion/create" style="text-decoration:none;">
        <button style="
            background:#1e5bff; 
            color:white; 
            padding:10px 20px; 
                ...
                <?php foreach ($direccions as $direccion): ?>
                    <tr style="background:white; border-bottom:1px solid #e2e2e2;">
                        ...
                        <td style="padding:12px;">
                            ...
                            <a href="/googlelamc/public/direccion/edit?iddireccion=<?= htmlspecialchars($direccion['iddireccion']); ?>">
                                <button style="
                                    background:#ffc107;
                                    color:black;
                                    padding:6px 12px;
                            ...
                            <a href="/googlelamc/public/direccion/eliminar?iddireccion=<?= htmlspecialchars($direccion['iddireccion']); ?>"
