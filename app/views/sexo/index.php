...
">
    ...
    <a href="/googlelamc/app/views/sexo/create.php" style="text-decoration:none;">
        <button style="
            background:#1e5bff; 
            color:white; 
            padding:10px 20px; 
            ...
            <?php if (!empty($sexos) && is_array($sexos)): ?>
                <?php foreach ($sexos as $sexo): ?>
                    <tr style="background:white; border-bottom:1px solid #e2e2e2;">
                        ...
                        <td style="padding:12px;">
                            <a href="/googlelamc/public/sexo/edit?idsexo=<?= htmlspecialchars($sexo['idsexo']); ?>">
                                <button style="
                                    background:#ffc107;
                                    color:black;
                                    padding:6px 12px;
                            ...
                            <a href="/googlelamc/public/sexo/eliminar?idsexo=<?= htmlspecialchars($sexo['idsexo']); ?>"
