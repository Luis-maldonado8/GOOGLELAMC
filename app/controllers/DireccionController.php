...
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamcconfig/database.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/models/Direccion.php';

require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/models/Persona.php';
