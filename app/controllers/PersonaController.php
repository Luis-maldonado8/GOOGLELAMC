...
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/config/database.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/app/models/Persona.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/app/models/Sexo.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/app/models/Estadocivil.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/app/models/Direccion.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/googleelamc/app/models/Telefono.php';
